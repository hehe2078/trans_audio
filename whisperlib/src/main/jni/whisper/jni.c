...
JNIEXPORT void JNICALL
Java_com_whispercpp_whisper_WhisperLib_00024Companion_fullTranscribeWithOptions(
        JNIEnv *env,
        jobject thiz,
        jlong context_ptr,
        jint num_threads,
    ...
    params.detect_language = strcmp(language_chars, "auto") == 0;
